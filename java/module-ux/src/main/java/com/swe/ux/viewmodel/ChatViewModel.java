...
/**
 * Frontend ViewModel - Headless, no file data handling.
 * Only manages metadata and user intent.
 */
public class ChatViewModel {
    ...
    private final String currentDisplayName = "B";
    ...
    /**
     * ============================================================================
     * MESSAGE VIEW MODEL - Updated for Metadata-Only
     * ============================================================================
     *
     * KEY: fileContent and compressedFileSize are metadata-only
     */


    public static synchronized ChatViewModel getInstance() {
        if (INSTANCE == null) {
    ...
    private ChatViewModel() {
        this.rpc = SocketryClientRPC.getInstance();
    ...
    public void cancelReply() {
        ...
        if (onReplyStateChange != null) onReplyStateChange.accept(null);
    }
